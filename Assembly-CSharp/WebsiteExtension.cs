...
public class WebsiteExtension
{
	public List<WebSiteDefinition> ExtendWebsites(List<WebSiteDefinition> Websites)
	{
		...
		this.AddSinglePageWebsite(Websites, "existance.txt", "EXISTANCE", "EXISTANCE", "You exist to let us out!", true, 1, true, CustomSoundLookUp.existance);
		...
		this.AddSinglePageWebsite(Websites, "leet.txt", "133734", "133734", "133733734", true, 2, true, CustomSoundLookUp.leettf);
		...
		this.AddSinglePageWebsite(Websites, "youlivehere.txt", "0x6D656174", "YouLiveHere", "YOU_LIVE_HERE!!!", true, 5, true, CustomSoundLookUp.livehere);
