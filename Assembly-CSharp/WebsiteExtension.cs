...
public class WebsiteExtension
{
	public List<WebSiteDefinition> ExtendWebsites(List<WebSiteDefinition> Websites)
	{
		...
		this.AddSinglePageWebsite(Websites, "burnedatthestake.txt", "Burned At The Stake", "BurnedAtTheStake", "Group of people who hunt down \"witches\"", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "cosmosreport.txt", "Cosmos Report", "CosmosReport", "Secret alien contact document project", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "darkbook.txt", "Darkbook", "Darkbook", "The facebook of the dark web.", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "deardaddy.txt", "Dear Daddy", "DearDaddy", "Random Poem", false, -1, false, null);
		...
		this.AddSinglePageWebsite(Websites, "decryptyou.txt", "Decrypt You", "DecryptYou", "Portal for ransom and hostage.", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "divinesyndicate.txt", "Divine Syndicate", "DivineSyndicate", "Hitman Network", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "doctormurder.txt", "Doctor Murder", "DoctorMurder", "Professional murder service for hire.", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "doge.txt", "DOGE", "DOGE", "WOW!", false, -1, true, CustomSoundLookUp.cool);
		this.AddSinglePageWebsite(Websites, "encrypta.txt", "Encrypta", "Encrypta", "A series of zeros and ones", true, 5, true, CustomSoundLookUp.encrypta);
		this.AddSinglePageWebsite(Websites, "enigma.txt", "Enigma", "Enigma", "Puzzle to solve the cosmos.", true, 5, true, CustomSoundLookUp.enigma);
		this.AddSinglePageWebsite(Websites, "envision.txt", "Envision", "Envision", "What do these pictures mean to you?", true, 5, true, CustomSoundLookUp.envision);
		this.AddSinglePageWebsite(Websites, "existance.txt", "EXISTANCE", "EXISTANCE", "You exist to let us out!", false, -1, true, CustomSoundLookUp.existance);
		...
		this.AddSinglePageWebsite(Websites, "gravethieves.txt", "Grave Thieves", "GraveThieves", "Service for stealing valuables from graves.", false, -1, false, null);
		...
		this.AddSinglePageWebsite(Websites, "illuminati.txt", "Illuminati", "Illuminati", "333", false, -1, true, CustomSoundLookUp.illuminati);
		...
		this.AddSinglePageWebsite(Websites, "leet.txt", "133734", "133734", "133733734", true, 3, true, CustomSoundLookUp.leettf);
		this.AddSinglePageWebsite(Websites, "legion.txt", "Legion", "Legion", "Weird cryptic webpage", false, -1, true, CustomSoundLookUp.legion);
		this.AddSinglePageWebsite(Websites, "nucleardream.txt", "Nuclear Dream", "NuclearDream", "Dude sells atomic arsenal to the highest bidder.", false, -1, true, CustomSoundLookUp.nuclear);
		this.AddSinglePageWebsite(Websites, "nudeyoutubers.txt", "NudeYoutubers", "NudeYoutubers", "Horny for video influencers?", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "rosesdestruction.txt", "Roses Destruction", "RosesDestruction", "Just fucked up...", false, -1, true, CustomSoundLookUp.rosesdestruction);
		this.AddSinglePageWebsite(Websites, "scamexchange.txt", "Scam Exchange", "AlsoScamExchange", "Free donation exchange platform for NFTs", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "secretboxoffice.txt", "Secret Box Office", "SecretBoxOffice", "What is in the Box?", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "shadowwebportal.txt", "Shadow Web Portal", "ShadowWeb", "Mysterious Shadow Web access point", false, -1, false, null);
		...
		this.AddSinglePageWebsite(Websites, "testicalmutilation.txt", "Testical Mutilation", "TesticalMutilation", "A woman’s fantasy of \"punishing men\" blog post.", false, -1, true, CustomSoundLookUp.testical);
		this.AddSinglePageWebsite(Websites, "theart.txt", "The Art", "RickRoll", "The art of what???", false, -1, ModsManager.Trolling, CustomSoundLookUp.theart);
		...
		this.AddSinglePageWebsite(Websites, "theendoflifeonearth.txt", "The End of Life on Earth", "InnerWorld", "Messed up kids thinking of living in a world built on thoughts.", false, -1, false, null);
		this.AddSinglePageWebsite(Websites, "thelurker.txt", "The Lurker", "TheLurker", "Web camera footage from some psychopath's basement.", false, -1, true, CustomSoundLookUp.morse);
		this.AddSinglePageWebsite(Websites, "youlivehere.txt", "0x6D656174", "YouLiveHere", "YOU_LIVE_HERE!!!", true, 3, true, CustomSoundLookUp.livehere);
		...
		this.AddDoublePageWebsite(Websites, "cannabisworld.txt", "CannabisWorld", "CannabisWorld", "The one and only place for high quality cannabis.", "cannabisworldorder.txt", "order.html", false, -1, ModsManager.Trolling, false, CustomSoundLookUp.cannabisworld, null);
		...
		this.AddDoublePageWebsite(Websites, "hermitblog.txt", "Hermit's Blog", "HermitBlog", "Some crazy old man sharing forbidden knowledge.", "hermitblogwarning.txt", "warning.html", false, -1, false, true, null, CustomSoundLookUp.whisper);
		...
		this.AddDoublePageWebsite(Websites, "planecrashinfo.txt", "PlaneCrashInfo", "PlaneCrashInfo", "Database that registers fatal plane flights.", "planecrashinfoerror.txt", "error.html", true, 0, false, false, null, null);
		...
		this.AddDoublePageWebsite(Websites, "theinvestigation.txt", "TH3 1NV3ST1G4T10N", "TheInvestigation", "IT community forum.", "theinvestigationerror.txt", "error.html", false, -1, false, false, null, null);
		...
		this.AddTriplePageWebsite(Websites, "dispatch.txt", "Dispatch", "Dispatch", "Creepy number stations decrypt blog post.", "dispatchtable.txt", "table.html", "dispatchbeware.txt", "beware.html", true, 2, true, false, true, CustomSoundLookUp.dispatch, null, CustomSoundLookUp.beware);
		this.AddTriplePageWebsite(Websites, "eurofirearms.txt", "Euro Firearms", "EuroFirearms", "The European weapons store front.", "eurofirearmsproducts.txt", "products.html", "eurofirearmsorder.txt", "order.html", true, 4, false, false, false, null, null, null);
		...
		this.AddTriplePageWebsite(Websites, "greetmysisters.txt", "Greet My Sisters", "GreetMySisters", "Family selling their daughters for pleasure.", "greetmysisterssisters.txt", "sisters.html", "greetmysistersorder.txt", "order.html", false, -1, false, false, false, null, null, null);
		...
		this.AddTriplePageWebsite(Websites, "piratehackers.txt", "PirateHACKERS", "PirateHACKERS", "Central chainpoint for hacker organisations and hacking activity.", "piratehackersliar.txt", "liar.html", "piratehackerslogin.txt", "login.html", false, -1, false, false, false, null, null, null);
		...
		this.AddTriplePageWebsite(Websites, "thespectralwhisperer.txt", "The Spectral Whisperer", "TheSpectralWhisperer", "Self-proclaimed Medium offers conflict solutions with Ghosts", "thespectralwhisperercontact.txt", "contact.html", "thespectralwhispererinfo.txt", "info.html", false, -1, false, false, false, null, null, null);
		...
		this.AddQuadriplePageWebsite(Websites, "tangodown.txt", "Tango Down", "TangoDown", "Hitman for hire website.", "tangodownpayment.txt", "payment.html", "tangodownresults.txt", "results.html", "tangodownhire.txt", "hire.html", true, 4, true, false, false, false, CustomSoundLookUp.tango, null, null, null);
		this.AddQuintiplePageWebsite(Websites, "tssa.txt", "The Secret Story Archive", "TheSecretStoryArchive", "A forum place to share your secret lifestories.", "tssakey.txt", "key.html", "tssa403.txt", "403.html", "tssa404.txt", "404.html", "tssasearch.txt", "search.html", false, -1, false, false, false, false, false, null, null, null, null, null);
		...
		this.AddSixtuplePageWebsite(Websites, "cashdash.txt", "Cash & Dash", "CashDash", "Video slots and roulette gambling.", "cashdashcrash.txt", "crash.html", "cashdashroulette.txt", "roulette.html", "cashdashclosed.txt", "closed.html", "cashdashunavailable.txt", "unavailable.html", "cashdashlogin.txt", "login.html", false, -1, false, false, false, false, false, false, null, null, null, null, null, null);
		...
		this.AddEighthPageWebsite(Websites, "salvina.txt", "Salvina Archives", "SalvinaArchives", "Database for Noxyamethystolis research conducted by Salvina Industries", "salvinaabout.txt", "about.html", "salvinacase51.txt", "case51.html", "salvinacase107.txt", "case107.html", "salvinacase245.txt", "case245.html", "salvinacase673.txt", "case673.html", "salvinaerror.txt", "error.html", "salvinaverification.txt", "verification.html", false, -1, false, false, false, false, false, false, false, false, null, null, null, null, null, null, null, null);
		this.AddNinePageWebsite(Websites, "backrooms.txt", "The Backrooms", "TheBackrooms", "Out of Reality!", "backroomslevel1.txt", "level1.html", "backroomslevel3.txt", "level3.html", "backroomslevel4.txt", "level4.html", "backroomslevel5.txt", "level5.html", "backroomslevel11.txt", "level11.html", "backroomslibrary.txt", "library.html", "backroomsvoid.txt", "void.html", "backroomslast.txt", "9223372036854775807.html", false, -1, false, false, false, false, false, false, false, true, false, null, null, null, null, null, null, null, CustomSoundLookUp.theend, null);
		...
		this.AddNinePageWebsite(Websites, "tomandjerry.txt", "Tom and Jerry", "TomAndJerry", "Fucked up drug central.", "tomandjerrycannabis.txt", "cannabis.html", "tomandjerrycocaine.txt", "cocaine.html", "tomandjerryerror.txt", "error.html", "tomandjerrylogin.txt", "login.html", "tomandjerrylsd.txt", "lsd.html", "tomandjerryorder.txt", "order.html", "tomandjerrysignup.txt", "signup.html", "tomandjerrysteroids.txt", "steroids.html", false, -1, false, false, false, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null);
		return Websites;
	}

	private void AddFakeWebsites(List<WebSiteDefinition> Websites)
	{
		Websites.Add(this.FakeWebPageStructure("A Cat’s Guide", "Rulebook written for the cat society on how to behave around humans", 9778));
		...
		Websites.Add(this.FakeWebPageStructure("Casefile 76B", "MKUltra survivor’s journal about his traumatic experiences", 9778));
		...
		Websites.Add(this.FakeWebPageStructure("Church of Merciful Release", "Cult dedicated to motivate to kill one another to save the Earth", 9778));
		...
		Websites.Add(this.FakeWebPageStructure("Downed Satan", "Website dedicated to something of pure art", 9778));
		...
		Websites.Add(this.FakeWebPageStructure("Monolith Alpha", "Scripture of truth, collected in one place", 9778));
		...
		Websites.Add(this.FakeWebPageStructure("Red Eyes", "Martian aliens contact portal", 9778));
		...
		Websites.Add(this.FakeWebPageStructure("Stinky Steak", "Some random dude making weird experiments beyond expiry date", 9778));
		Websites.Add(this.FakeWebPageStructure("Testing Grounds LSD", "Laboratory with humans subjected to all types of drugs.", 9778));
		Websites.Add(this.FakeWebPageStructure("The Black Vault", "You will never be able to open it...", 9778));
	...
	private void AddDeepWebRadio(List<WebSiteDefinition> Websites)
	{
		WebSiteDefinition webSiteDefinition = ScriptableObject.CreateInstance<WebSiteDefinition>();
		WebPageDefinition webPageDefinition = ScriptableObject.CreateInstance<WebPageDefinition>();
		WebPageDefinition webPageDefinition2 = ScriptableObject.CreateInstance<WebPageDefinition>();
		...
		webPageDefinition.IsTapped = false;
		webPageDefinition.PageEvent = null;
		webPageDefinition.PageHTML = "Deep Web Radio \n DJ Admin \n Deep Web Radio « Stream » /AnonyJazz \n Stream Title:\tAnony JaZZ \n Stream Description:\tReally a lot of jazz... \n Content Type:\taudio/mpeg \n Bitrate:\t96 \n Current Listeners:\t1 \n Peak Listeners:\t14 \n Stream Genre:\tJazz and Latin";
		webPageDefinition.PageName = "Deep Web Radio";
		webPageDefinition.isWTTG1Website = true;
		webPageDefinition2.id = this.dynamicId;
		this.dynamicId++;
		webPageDefinition2.AudioFile = null;
		webPageDefinition2.HasMusic = false;
		webPageDefinition2.FileName = "radio.html";
		webPageDefinition2.HashIndex = 0;
		webPageDefinition2.HashValue = string.Empty;
		webPageDefinition2.IsTapped = false;
		webPageDefinition2.PageEvent = null;
		webPageDefinition2.PageHTML = "<a> Sit down, dim the lights, and relax, or just stare at the screen while listening to the music. Headphones are recommended for better experience. Thank you for choosing AnonyJazz. Enjoy your stay at the Deep Web Radio station. If you have any requests for music contact us below </a>";
		webPageDefinition2.PageName = "Deep Web Radio Jazz";
		webPageDefinition2.isWTTG1Website = true;
		webSiteDefinition.id = this.dynamicId;
		this.dynamicId++;
		webSiteDefinition.isFake = false;
		webSiteDefinition.DoNotList = false;
		webSiteDefinition.DoNotTap = true;
		webSiteDefinition.isStatic = true;
		webSiteDefinition.HasWindow = false;
		webSiteDefinition.WindowTime = WEBSITE_WINDOW_TIME.FIRST_QUARTER;
		webSiteDefinition.PageTitle = "Deep Web Radio";
		webSiteDefinition.PageDesc = "Radio livestreaming service for anarchial music.";
		webSiteDefinition.PageURL = "deepwebradix127to5n2tid0anon2rad";
		webSiteDefinition.DocumentRoot = "DeepWebRadio";
		webSiteDefinition.HoldsSecondWikiLink = false;
		webSiteDefinition.IsTapped = false;
		webSiteDefinition.WasVisted = false;
		webSiteDefinition.WikiIndex = 0;
