...
public class WebsiteExtension
{
	public List<WebSiteDefinition> ExtendWebsites(List<WebSiteDefinition> Websites)
	{
		...
		this.AddDoublePageWebsite(Websites, "blackhatpost.txt", "Black Hat Post", "BlackHatPost", "Hackers doxxing people for money.", "blackhatpostsubmit.txt", "submit.html", true, 5, false, false);
		...
		this.AddDoublePageWebsite(Websites, "finalthoughts.txt", "Final Thoughts", "FinalThoughts", "Not the kind of suicide hotline you're thinking.", "finalthoughtscontact.txt", "contact.html", true, 0, false, false);
		...
		this.AddSinglePageWebsite(Websites, "illuminati.txt", "Illuminati", "Illuminati", "333", false, -1, true);
