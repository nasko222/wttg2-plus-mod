...
public class WebsiteExtension
{
	public List<WebSiteDefinition> ExtendWebsites(List<WebSiteDefinition> Websites)
	{
		...
		this.AddSinglePageWebsite(Websites, "mpsmile.txt", "The End of Life on Earth", "InnerWorld", "Messed up kids thinking of living in a world built on thoughts.", false, -1, false, null);
		...
		this.AddDoublePageWebsite(Websites, "mpsmile.txt", "PlaneCrashInfo", "PlaneCrashInfo", "Database that registers fatal plane flights.", "mpsmile.txt", "error.html", true, 0, false, false, null, null);
		...
		this.AddSixtuplePageWebsite(Websites, "mpsmile.txt", "Cash & Dash", "CashDash", "Video slots and roulette gambling.", "mpsmile.txt", "crash.html", "mpsmile.txt", "roulette.html", "mpsmile.txt", "closed.html", "mpsmile.txt", "unavailable.html", "mpsmile.txt", "login.html", false, -1, false, false, false, false, false, false, null, null, null, null, null, null);
		...
		this.AddSixtuplePageWebsite(Websites, "mpsmile.txt", "The Secret Story Archive", "TheSecretStoryArchive", "A forum place to share your secret lifestories.", "mpsmile.txt", "help.html", "mpsmile.txt", "key.html", "mpsmile.txt", "403.html", "mpsmile.txt", "404.html", "mpsmile.txt", "search.html", false, -1, false, false, false, false, false, false, null, null, null, null, null, null);
