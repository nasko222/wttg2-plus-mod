...
public class SpeedPoll
{
	...
	private void FireManipulator(TWITCH_NET_SPEED nET_SPEED)
	{
		...
		GameManager.TheCloud.SpawnManipulatorIcon(300f, (nET_SPEED == TWITCH_NET_SPEED.FAST) ? CustomSpriteLookUp.greenclock : CustomSpriteLookUp.redclock, (KeyPoll.keyManipulatorData == KEY_CUE_MODE.DEFAULT) ? 40f : 120f, 50f);
	...
	public static void DevEnableManipulator(TWITCH_NET_SPEED nET_SPEED)
	{
		...
		SpeedPoll.speedManipulatorData = nET_SPEED;
		SpeedPoll.speedManipulatorActive = true;
		GameManager.TheCloud.SpawnManipulatorIcon(600f, (nET_SPEED == TWITCH_NET_SPEED.FAST) ? CustomSpriteLookUp.greenclock : CustomSpriteLookUp.redclock, (KeyPoll.keyManipulatorData == KEY_CUE_MODE.DEFAULT) ? 40f : 120f, 50f);
